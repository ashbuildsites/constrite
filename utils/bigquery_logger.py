...
class BigQueryLogger:
    ...
    def log_analysis(self, analysis_data: Dict, site_info: Dict) -> Optional[str]:
        ...
        try:
            ...
            # Prepare row data - convert JSON arrays to strings
            ...
            row = {
                ...
                'critical_violations': json_lib.dumps(analysis_data.get('critical_violations', [])),
                'warnings': json_lib.dumps(analysis_data.get('warnings', [])),
                'compliant_items': json_lib.dumps(analysis_data.get('compliant_items', [])),
    ...
    def create_dataset_and_table(self):
        ...
        try:
            ...
            schema = [
                ...
                bigquery.SchemaField("critical_violations", "STRING", mode="NULLABLE"),
                bigquery.SchemaField("warnings", "STRING", mode="NULLABLE"),
                bigquery.SchemaField("compliant_items", "STRING", mode="NULLABLE"),
